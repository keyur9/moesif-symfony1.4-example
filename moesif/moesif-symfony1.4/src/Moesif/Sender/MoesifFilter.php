...
// namespace Moesif\Filter;

// Remove error_log from here
// Need to check where it would create an log file?
// Remove the local reference to the files

use DateTime;
use DateTimeZone;
// use Moesif\Sender\MoesifApi;
require_once 'MoesifApi.php';
use Moesif\Sender\MoesifApi;
